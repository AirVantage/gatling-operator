...
import (
	...
	gatlingoperatorv1alpha1 "github.com/st-tech/gatling-operator/api/v1alpha1"
...
func init() {
	...
	utilruntime.Must(gatlingoperatorv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0d2e74aa.tech.zozo.com",
	})
	if err != nil {
